...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() 
	{
		...
		{
			degSeq.add(getInNeighbors(i).size() + getNeighbors(i).size());
//			degSeq.add(i, getInNeighbors(i).size() + getNeighbors(i).size());
			
//			List<Integer> list = getNeighbors(i);
//			degSeq.add(list.size());
//			for(int j = 0; j < numVertices; j++)
//			{
//				List<Integer> listIn = getNeighbors(j);
//				if(listIn.contains(i))
//					degSeq.set(i, degSeq.get(i) + 1);
//			}
		}
